...
class InferenceModule:
    ...
    def getPositionDistributionHelper(self, gameState, pos, index, agent):
        ...
        ghostPosition = gameState.getGhostPosition(index +
                                                   1)  # The position you set
        dist = DiscreteDistribution()
    ...
    def setGhostPositions(self, gameState, ghostPositions):
        ...
        for index, pos in enumerate(ghostPositions):
            ...
            gameState.data.agentStates[index + 1] = game.AgentState(
                conf, False)
        return gameState
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        "*** YOUR CODE HERE ***"
        self.particles = [
            self.legalPositions[i % len(self.legalPositions)]
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            dist[particle] += self.getObservationProb(observation,
                                                      PacmanPosition, particle,
                                                      jailPosition)
...
class JointParticleFilter(ParticleFilter):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        "*** YOUR CODE HERE ***"
        dist = DiscreteDistribution()
        PacmanPosisiton = gameState.getPacmanPosition()

        for particle in self.particles:
            weight = 1
            for i in range(self.numGhosts):
                weight *= self.getObservationProb(observation[i],
                                                  PacmanPosisiton, particle[i],
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            "*** YOUR CODE HERE ***"
            for i in range(self.numGhosts):
                newParticle[i] = self.getPositionDistribution(
                    gameState, oldParticle, i, self.ghostAgents[i]).sample()
            """*** END YOUR CODE HERE ***"""
