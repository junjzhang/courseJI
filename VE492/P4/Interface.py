...
class BadValueConstraint(UnaryConstraint):
    ...
    def __repr__(self):
        return 'BadValueConstraint (%s) {badValue: %s}' % (str(
            self.var), str(self.badValue))
...
class GoodValueConstraint(UnaryConstraint):
    ...
    def __repr__(self):
        return 'GoodValueConstraint (%s) {goodValue: %s}' % (str(
            self.var), str(self.goodValue))
...
class ConstraintSatisfactionProblem:
    ...
    def __init__(self,
                 variables,
                 domains,
                 binaryConstraints=None,
                 unaryConstraints=None):
    ...
    def __repr__(self):
        return '---Variable Domains\n%s---Binary Constraints\n%s---Unary Constraints\n%s' % (
            ''.join([
                str(e) + ':' + str(self.varDomains[e]) + '\n'
                for e in self.varDomains
            ]), ''.join([str(e) + '\n'
                         for e in self.binaryConstraints]), ''.join(
...
class Assignment:
    ...
    def __repr__(self):
        return '---Variable Domains\n%s---Assigned Values\n%s' % (''.join([
            ...
            str(e) + ':' + str(self.assignedValues[e]) + '\n'
